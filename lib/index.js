...
async function readLockText(lockPath, io) {
	try {
...
function isolatePathFor(lockPath, pid) {
...
async function restoreIsolatedLock(isolatePath, lockPath, io) {
	try {
...
*/
async function breakStaleWriterLock(lockPath, io = defaultIo) {
	...
	if (await readLockText(isolated, io) !== first || isPidAlive(pid) !== false) {
