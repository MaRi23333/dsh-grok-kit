...
async function breakStaleWriterLock(lockPath) {
	...
	if (pid === void 0 || isPidAlive(pid) !== false) return void 0;
	...
	*/
	async clearStaleLock() {
		try {
			...
			if (pid !== void 0) console.warn(`dsh-grok-kit: removed writer lock ${this.lockFilename}.lock left by dead process ${pid}; continuing normally.`);
		} catch {}
	}
