...
import { Api, AssistantMessage, AssistantMessageEvent, AuthInteraction, Credential, CredentialInfo, CredentialStore, Model, MutableModels, OAuthCredential, Provider } from "@earendil-works/pi-ai";
...
declare function stripRejectToolCalls(message: AssistantMessage): AssistantMessage;
declare function sanitizeRejectToolEvent(event: AssistantMessageEvent): AssistantMessageEvent | undefined;
/**
